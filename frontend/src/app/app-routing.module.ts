...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'blogDetail/:id', loadChildren:()=>import('./components/blog/blog-detail/blog-detail.module').then((mod)=>mod.BlogDetailModule) },
      ...
      { path: 'workshop', loadChildren:()=> import('./components/workshop/workshop.module').then ((mod)=>mod.WorkshopModule) }
    ]
  }
];
