...
export class MultiLineChartComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.data = this.TEMPERATURES.map((v:any) => v.values.map((v:any) => v.date))[0];
  ...
  private initChart(): void {
    this.svg = d3.select('#multiLineChart').append('svg')
      .attr('width', 500)
      .attr('height', 300);
    ...
    this.y.domain([
      d3Array.min(this.TEMPERATURES, function (c:any) { return d3Array.min(c.values, function (d:any) { return d.temperature; }); }),
      d3Array.max(this.TEMPERATURES, function (c:any) { return d3Array.max(c.values, function (d:any) { return d.temperature; }); })
    ]);

    this.z.domain(this.TEMPERATURES.map(function (c:any) { return c.id; }));
  }
